...
# Run with:
#   mpiexec -n <nprocs> python overlapping_weakscaling_one_form_3d.py <dofs_per_core> <degree> [csv_path]

if len(argv) < 3:
	raise ValueError("Usage: overlapping_weakscaling_one_form_3d.py <dofs_per_core> <degree> [csv_path]")
