...
def run(V1, V2):
    ...
    t1 = perf_counter_ns()
    P0DG_Omega_v_time_s = COMM_WORLD.allreduce(t1 - t0, op=MPI.MAX) / 1e9
    ...
    t0 = perf_counter_ns()
    P0DG_Omega_v_io = FunctionSpace(Omega_v.input_ordering, "DG", 0)
    t1 = perf_counter_ns()
    P0DG_Omega_v_io_time_s = COMM_WORLD.allreduce(t1 - t0, op=MPI.MAX) / 1e9
    ...
    return Omega_v_time_s, P0DG_Omega_v_time_s, A_time_s, P0DG_Omega_v_io_time_s, B_time_s, I_time_s

TIMING_NAMES = [
    "Omega_v_time_s",
    "P0DG_Omega_v_time_s",
    "A_time_s",
    "P0DG_Omega_v_io_time_s",
    "B_time_s",
    "I_time_s",
]
N_RUNS = 10
