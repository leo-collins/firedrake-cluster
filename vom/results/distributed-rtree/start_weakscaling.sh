...
python3 "$START_JOBS" vom_weakscaling_3d 100000 --env "$ENV" --ncpus 64 --num_nodes 2 --mem 15 --walltime 10 --exclusive
python3 "$START_JOBS" vom_weakscaling_3d 100000 --env "$ENV" --ncpus 64 --num_nodes 4 --mem 35 --walltime 10 --exclusive
python3 "$START_JOBS" vom_weakscaling_3d 100000 --env "$ENV" --ncpus 64 --num_nodes 8 --mem 50 --walltime 15 --exclusive
