...
python3 "$START_JOBS" vom_weakscaling_3d_flamegraph 100000 --env "$ENV" --ncpus 64 --num_nodes 2 --mem 150 --exclusive --result-subdir distributed-rtree-logging
python3 "$START_JOBS" vom_weakscaling_3d_flamegraph 100000 --env "$ENV" --ncpus 64 --num_nodes 4 --mem 400 --walltime 720 --exclusive --result-subdir distributed-rtree-logging
python3 "$START_JOBS" vom_weakscaling_3d_flamegraph 100000 --env "$ENV" --ncpus 64 --num_nodes 8 --mem 400 --walltime 720 --exclusive --result-subdir distributed-rtree-logging
