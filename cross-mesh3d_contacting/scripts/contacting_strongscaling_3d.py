...
# matrices with fully contacting meshes.
# Run with:
#   mpiexec -n <nprocs> python contacting_strongscaling_3d.py <total_dofs> <degree> [csv_path]

if len(argv) < 3:
	raise ValueError("Usage: contacting_strongscaling_3d.py <total_dofs> <degree> [csv_path]")
