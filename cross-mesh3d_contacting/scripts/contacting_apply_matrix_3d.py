...
# warmed-up application between contacting meshes.
# Run with:
#   mpiexec -n <nprocs> python contacting_apply_matrix_3d.py <dofs_per_core> <degree> [csv_path]

if len(argv) < 3:
    raise ValueError(
        "Usage: contacting_apply_matrix_3d.py <dofs_per_core> <degree> [csv_path]"
    )
