...
# action with fully contacting meshes.
# Run with:
#   mpiexec -n <nprocs> python contacting_weakscaling_one_form_3d.py <dofs_per_core> <degree> [csv_path]

if len(argv) < 3:
	raise ValueError("Usage: contacting_weakscaling_one_form_3d.py <dofs_per_core> <degree> [csv_path]")
